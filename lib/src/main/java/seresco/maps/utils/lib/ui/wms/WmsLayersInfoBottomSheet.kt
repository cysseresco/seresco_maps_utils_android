...
//class WmsLayersInfoBottomSheet(callback: OnWmsLayerSelectedItemsCallback, items: List<WMSLayer>, private var listener: WmsLayerItemInfoDetailAdapter.WmsItemSelectedItemItemClickListener): BottomSheetDialogFragment(), WmsLayerItemInfoAdapter.WmsLayerSelectedItemItemClickListener,
//    Constant {
//
...
//    ): View? = inflater.inflate(R.layout.bottom_sheet_wms_layers_info, container, false)
//
